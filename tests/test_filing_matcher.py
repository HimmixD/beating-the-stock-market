...
# ---------------------------------------------------------------------------
# newer filing is selected when as_of_date is in the future
# ---------------------------------------------------------------------------

def test_select_best_candidate_prefers_newest_known_filing():
    matcher = FilingFinancialMatcher()
    ...
    result = matcher._select_best_candidate(
        openbb_value=FinancialValue(
            symbol="MSFT",
            field="revenue",
            value=95.0,
